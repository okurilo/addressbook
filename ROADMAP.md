...
- [x] Разместить адаптер `Employee[]` к донорской форме рядом с вызовом внутри `src/apps/AddressBook`.
...
- [x] Добавить недостающие assets внутрь папки компонента и точные mocks поиска/профиля внутрь папки приложения.
