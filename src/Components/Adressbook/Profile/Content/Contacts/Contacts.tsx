...
export const Contacts: FC<IContactsProps> = ({ internalPhone, personalPhone, pid, profile }) => {
  const handleCopyPhone = (phone: string) => {
    navigator.clipboard.writeText(phone);
  };

  const { workAddress, mailSigma, mailAlpha, sberchat, timezone, linearManager } = profile;
