...
const departmentNodes: DepartmentNode[] = [
  ...
  createNode(
    'dept-digital-platforms',
    'Управление цифровых платформ',
    148,
    'central-office',
    '1001'
  ),
  createNode(
    ...
    'Департамент операционной эффективности',
    121,
    'central-office',
    '1002'
  ),
  ...
  createNode(
    'dept-process-transformation',
    'Центр трансформации процессов',
    109,
    'central-office',
    '1004'
  ),
  ...
  createNode(
    'dept-infrastructure',
    'Инженерный блок инфраструктуры',
    167,
    'central-office',
    '1007'
  ),
  createNode(
    'dept-compliance-control',
...
const buildPath = (departmentId: string): DepartmentDetails['path'] => {
  ...
  while (currentNode !== undefined) {
    ...
    currentNode = currentNode.parentId === null ? undefined : nodesById.get(currentNode.parentId);
  }
