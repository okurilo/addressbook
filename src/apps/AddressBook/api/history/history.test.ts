      ...
      return new Response(
        JSON.stringify({
          data: [
            ...
            {
              id: 'history-2',
              path: 'globalsearch:learningcatalog',
              text: 'Курс по TypeScript',
              key: {
                context: SearchContextEnum.learningcatalog,
                id: 'course-1',
              },
            },
          ],
  ...
  assert.deepEqual(requests, [
    {
      body: null,
      method: 'GET',
      url: '/api-web/globalsearch/api/v3/history?paths=persons&size=4',
    },
    {
      body: '{}',
      method: 'POST',
