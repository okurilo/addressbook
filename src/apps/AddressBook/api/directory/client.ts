import type { Employee, EmployeeSearchResponse, DirectorySearchResponse } from './types';
...
): Promise<DirectorySearchResponse> => fetchDirectorySuggestions(query, signal, category);
