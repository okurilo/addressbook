...
- React-тесты AddressBook используют единый `AllTheProviders`/custom render внутри границы поставки; моки типизируются и сбрасываются между тестами, а изменения product-кода ради coverage запрещены.
